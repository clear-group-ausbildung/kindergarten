    ...
    if (allPDFFiles.size() != 0) {
      ...
      if (defaultService == null) {
        ...
        int reply = JOptionPane.showConfirmDialog(null,
            "Sie sind dabei ALLE Abrechnungen zu drucken. M\u00f6chten Sie fortfahren?", "Alle Abrechnunge Drucken",
            JOptionPane.YES_NO_OPTION);
        if (reply == JOptionPane.YES_OPTION) {
          javax.print.PrintService service = ServiceUI.printDialog(null, 200, 200, services, defaultService, flavor,
              attributes);
          if (service != null) {
      ...
      JOptionPane.showMessageDialog(new JFrame(), "Keine Verk\u00e4ufer erfasst Drucken nicht m\u00f6glich!", "Fehler",
