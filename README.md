...
- [ ] 5. Bei den Summenfeldern, werden anstatt 10,50 € -> 10,5 € angezeigt. Hier bitte das Format ändern.
- [ ] 5b. wenn du in der Verkaufserfassung bist und mal die Feler NUR mit dem Keyboard bedienst...eingeben Tab eingeben Tab eingeben Enter - Dann sollte der Fokus nach dem Enter (also Datensatz unten in die Tablle schreiben) auch wieder zurück ins erste Feld (Verkäufernummer springen.)
